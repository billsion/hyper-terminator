...
//$_SESSION['views']
$fromx = ($_SESSION['views']-1)*3;
$x = 0;        

//echo $fromx;

  $resultt = mysql_query( "SELECT theID,times,url0,url1,url2,url3 FROM runipfs ORDER BY times DESC LIMIT  ".$fromx.", 3"  );  
...
echo "{\"html\":\"<li><a target=_blank href=\\\"view.php?theID=".$data[0]."\\\"><dl><dt>编号：".$data[0]."<\\/dt><dd class=\\\"content\\\"><img src=\\\"".$data[2]."\\\" width=\\\"90%\\\"><\\/dd><dd class=\\\"source\\\">计算结果：".$data[3]."<\\/dd><\\/dl><\\/a><\\/li>\"}";
}
$x++; //最后一个逗号 第10个不要逗号
if($x < $ts)
{
